...
function Leaderboard() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 p-8 text-zinc-100 font-mono">
      ...
      <h1 className="text-3xl mb-8 tracking-tighter border-b border-zinc-800 pb-2">TOP AGENTS</h1>

      {loading ? <p>Decrypting rankings...</p> : (
            ...
            <tbody>
              {leaders.map((user, index) => (
                <tr key={user._id} className="border-t border-zinc-800 hover:bg-zinc-800/50">
                  ...
                  <td className="p-4 text-right text-green-500">{user.solvedPuzzles.length}</td>
                </tr>
              ))}
            </tbody>
          </table>
